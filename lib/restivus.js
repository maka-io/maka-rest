    ...
    if (this._config.enableCors) {
      ...
      if (!this._config.defaultOptionsEndpoint) {
        ...
        this._config.defaultOptionsEndpoint = function() {
          this.response.writeHead(200, that._config.defaultHeaders);
          return this.done();
        };
      }
    }
  ...
  _initAuth() {
    ...
    this.addRoute('login', {authRequired: false}, {
      post() {
        ...
        const extra = self._config.onLoggedIn != null ? self._config.onLoggedIn.call(this) : undefined;
        if (extra != null) {
          Object.assign(auth, { extra });
        }
    ...
    const logout = function() {
      ...
      const extra = self._config.onLoggedOut != null ? self._config.onLoggedOut.call(this) : undefined;
      if (extra != null) {
        Object.assign(auth, { extra });
      }
    ...
    const logoutAll = function() {
      ...
      if (extraData != null) {
        _.extend(this.response.data, {extra: extraData});
      }
