        ...
        restivus.addRoute(swaggerPath, {authRequired: false}, {
            get: function () {
                ...
                if(swagger === undefined ||
                    ...
                    // Don't bring in the paths property just yet
                    let foundPaths = {}
                    if (swagger.paths) {
                            ...
                            !route.path.includes('users') )
                        {
                            ...
                            endpoints.forEach((endpoint) => {
                                ...
                                if(currentEndpoint.swagger !== undefined) {
                                    ...
                                    // If no definitions were found in the swagger prop, check through swagger.
                                    // TODO: Get this done later
