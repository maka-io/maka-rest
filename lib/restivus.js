...
class Restivus {
          ...
          action() {
            if (collection.remove(this.urlParams.id)) {
              return {
                statusCode: 200,
                status: 'success',
                data: `Deleted: ${this.urlParams.id}`
              };
            } else {
              return {
                statusCode: 404,
  ...
  _initAuth() {
    ...
    this.addRoute('login', {authRequired: false}, {
      post() {
        ...
        try {
          ...
          return{
            statusCode: e.error,
            body: { statusCode: 500, status: 'error', data: 'Error attempting login' }
          };
        }
        ...
        const response = { statusCode: 200, status: 'success', data: auth};
    ...
    const logout = function() {
      ...
      const response = { statusCode: 200, status: 'success', data: 'KTHXBYE!'};
    ...
    const logoutAll = function() {
      ...
      const response = { statuCode: 200, status: 'success', data: 'KTHXBYE!' };
...
const badRequest400 = (data = 'Bad Request') => {
  return {
    statusCode: 400,
    status: 'fail',
    data
...
const notFound404 = (data = 'Not Found') => {
  return {
    statusCode: 404,
    status: 'fail',
    data
...
const unsupported415 = (data = 'Unsupported') => {
  return {
    statusCode: 415,
    status: 'fail',
    data
...
const serverError500 = (data = 'Server Error') => {
  return {
    statusCode: 500,
    status: 'error',
    data
...
const Codes = { success200, success201, badRequest400, notFound404, unsupported415, serverError500 };
